      ...
      <Modal isOpen={this.props.modal} toggle={this.props.toggle} className="modal-lg"  keyboard={false} backdrop="static">
        <ModalHeader toggle={this.props.toggle}>Privacy Policy</ModalHeader>
          <ModalBody>
            ...
            <br/>
            <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at https://www.App_renticeai.co/ , unless otherwise defined in this Privacy Policy.</p>
            <br/>
